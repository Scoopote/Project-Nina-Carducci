  ...
  $.fn.mauGallery.methods = {
    ...
    wrapItemInColumn(element, columns) {
      if (columns.constructor === Number) {
        element.wrap(
          "<div class='item-column mb-4 col-" +
            Math.ceil(12 / columns) +
            "'></div>"
        );
    ...
    openLightBox(element, lightboxId) {
      ...
      $("#" + (lightboxId || "galleryLightbox")).modal("toggle");
    },
    ...
    prevImage(lightboxId) {
      ...
      if (!imagesCollection.length || !activeImage) {
        return;
      }
    ...
    /** FILTRE : garder la classe active + active-tag */
    filterByTag() {
      ...
      $(".gallery-item").each(function() {
        var $column = $(this).parents(".item-column");
        $column.hide();
